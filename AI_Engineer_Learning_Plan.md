...
### Lists
**What it is:** Ordered, mutable collection of items enclosed in square brackets.

**Why it is used:** To store multiple items in a single variable, allowing modifications.
...
### Tuples
**What it is:** Ordered, immutable collection of items enclosed in parentheses.

**Why it is used:** For data that shouldn't change, like coordinates or configuration values.
...
### Dictionaries
**What it is:** Unordered collection of key-value pairs enclosed in curly braces.

**Why it is used:** For storing data with meaningful keys for fast lookup.
...
print(student.values())  # dict_values(['John', 23, 'New York'])
...
### Sets
**What it is:** Unordered collection of unique items enclosed in curly braces.

**Why it is used:** For storing unique values and performing set operations.

**Example:**
```python
# Creating sets
colors = {"red", "green", "blue"}
numbers = {1, 2, 3, 3, 3}  # Duplicates are ignored
...
### for Loop
**What it is:** Iterates over a sequence (list, tuple, string, range).
...
### Defining Functions
**What it is:** Reusable blocks of code that perform specific tasks.
...
user = create_user(city="NYC", name="John", age=30)
```
...
## Day 136-140: Final Capstone Project

### End-to-End AI Application

```python
"""
Capstone Project: AI-Powered Document Q&A System
...
async def ask_question(question: Question):
    if vectorstore is None:
        return Answer(answer="Please upload a document first", sources=[])
...
@app.get("/health")
async def health():
    return {"status": "healthy", "documents_loaded": vectorstore is not None}
```
